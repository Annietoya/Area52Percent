...
// Mechanic - Aliens - Play
// this is applied on the UFO object
// this sends out a raycast to collect the individual cows
...
public class SC_CowAbduction : MonoBehaviour
{
    ...
    private void Start()
    {
        ...
        uIManager = GameObject.Find("Canvas").GetComponent<SC_UIManager>();
